...
// ----+ CRIANDO OBJETO
const padaria03 = new EstabelecimentoBase(
...
class Restaurante {
  ...
  //metodo get
  get filaEspera() {
    //se vc n coloca nada o metodo é publico por padrão
...
const restaurante01 = new Restaurante("rua tachizeiro, 78", "alimentação", [
